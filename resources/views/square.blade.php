    ...
    <div class="container">
        <div class="main-form">
            ...
            <div class="row mb-4 nav-row-wrapper">
                ...
                <div class="col-sm-3 nav-btn-wrapper">
                    <a class="btn btn-light active" href="{{ route('square.shape') }}">Square</a>
                </div>
                <div class="col-sm-3 nav-btn-wrapper">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h1>Square Shape</h1>
                    <h5>Square Area: {{ $squareArea }} cm</h5>
                    <h5>Square Perimeter: {{ $squarePerimeter}} cm</h5>
                </div>
                <div class="col-md-6">
                    <form>
                        <div class="mb-3">
                            <label for="length">Square length</label>
                            <input type="number" name="length" class="form-control" id="number-1" placeholder="Enter your square line length" required>
                        </div>
